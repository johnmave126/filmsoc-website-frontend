...
cr.define('cr.ui', function() {
  ...
  BubbleBase.prototype = {
    ...
    show: function() {
      ...
      this.eventTracker_.add(doc, 'keydown', this.handleEvent.bind(this), true);
      this.eventTracker_.add(doc, 'mousedown', this.handleEvent.bind(this), true);
    },
  ...
  AutoCloseBubble.prototype = {
    ...
    show: function() {
      ...
      var doc = this.ownerDocument;
      this.eventTracker_.add(doc, 'mousewheel', this.handleEvent.bind(this), true);
      this.eventTracker_.add(doc, 'scroll', this.handleEvent.bind(this), true);
      this.eventTracker_.add(doc, 'elementFocused', this.handleEvent.bind(this), true);
      this.eventTracker_.add(window, 'resize', this.handleEvent.bind(this));
    },
